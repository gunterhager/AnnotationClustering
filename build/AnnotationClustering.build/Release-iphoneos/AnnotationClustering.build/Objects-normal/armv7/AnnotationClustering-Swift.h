...
/// Class that represents an annotation cluster.\Note 
///
/// Needs to subclass NSObject to be able to conform to MKAnnotation
SWIFT_CLASS("_TtC20AnnotationClustering17AnnotationCluster")
...
@interface AnnotationCluster (SWIFT_EXTENSION(AnnotationClustering)) <MKAnnotation>
@end
...
SWIFT_CLASS("_TtC20AnnotationClustering21AnnotationClusterView")
...
///
/// \param annotation Annotation that represents a cluster.
- (void)reuseWithAnnotation:(AnnotationCluster * _Nonnull)annotation;
@end
